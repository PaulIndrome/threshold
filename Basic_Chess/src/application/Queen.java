...
public class Queen extends ChessFigure {
	...
	public Queen(boolean team, int col, int row, FieldRectangle[][] rectArray, GlowField[][] glowArray, Pane fieldPane,
		...
		// invalid.");
		// }
		this.icon = new ImageView("" + team + "queen.png");
		this.type = 4;
		...
		this.icon.hoverProperty().addListener(e->{
			if((ChessFieldController.getActiveTeam() == this.team && this.icon.isHover()))
				this.icon.setEffect(new ImageInput(new Image(""+team+"queensel.png"),icon.getX(),icon.getY()));
			else 
