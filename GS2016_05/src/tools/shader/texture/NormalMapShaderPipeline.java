...
public final class NormalMapShaderPipeline extends AbstractShaderPipeline {
	...
	public NormalMapShaderPipeline(GL3 gl, PMVMatrix matrixStack, Material material, Light light) {
	...
	protected void setUniforms() {
		...
		// set the uniform variable "sampler2D normalMap" to texture unit 0
		gl.glUniform1i(locNormalMap, 0);

	}

	@Override
	protected String getFilenameVertexShader() {
		return "NormalMapShaderVertex.glsl";
	}

	@Override
	protected String getFilenameFragmentShader() {
		return "NormalMapShaderFragment.glsl";
	}
