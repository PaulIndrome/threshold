	...
	static class GLEventListenerImpl implements GLEventListener {
		...
		public void display(GLAutoDrawable drawable) {
			...
			if (gl != null) {
				...
				gl.glLineWidth(4.0F);
				gl.glDrawElements(GL_LINE_LOOP, elementCount, GL_UNSIGNED_INT, 0L);
			}
		...
		public void init(GLAutoDrawable drawable) {
			if (drawable.getGL().isGL3()) {
				...
				float[] vertexColorData = new float[36 * 5];
				...
				IntBuffer faces = Buffers.newDirectIntBuffer(indexData);
				faces.rewind();
