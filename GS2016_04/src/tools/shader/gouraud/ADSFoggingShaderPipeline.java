...
public final class ADSFoggingShaderPipeline extends AbstractShaderPipeline {

	public ADSFoggingShaderPipeline(GL3 gl, PMVMatrix matrixStack, Material material, Light light, LinearFog fog) {
	...
	protected int locFogColor = -1;
	protected int locFogEnd = -1;
	protected int locFogScale = -1;
	...
	public void setFog(LinearFog fog) {
		this.fog = fog;
	}
	...
	protected void getLocations() {
		...
		locFogColor = gl.glGetUniformLocation(shaderProgram, "fogColor");
		locFogEnd = gl.glGetUniformLocation(shaderProgram, "fogEnd");
		locFogScale = gl.glGetUniformLocation(shaderProgram, "fogScale");
	...
	protected void setUniforms() {
		...
		gl.glUniform4fv(locFogColor, 1, fog.getColor(), 0);
		gl.glUniform1f(locFogEnd, fog.getEnd());
		gl.glUniform1f(locFogScale, fog.getScale());

	}

	@Override
	protected String getFilenameVertexShader() {
		return "ADSFoggingShaderVertex.glsl";
	}

	@Override
	protected String getFilenameFragmentShader() {
		return "ADSFoggingShaderFragment.glsl";
	}
