...
public abstract class AbstractADShaderPipeline extends AbstractShaderPipeline {
	...
	public AbstractADShaderPipeline(GL3 gl, PMVMatrix matrixStack, Material material, Light light) {
