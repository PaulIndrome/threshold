...
import tools.shader.phong.PhongShaderPipeline;
...
public class Listing09 {
	...
	static class GLEventListenerImpl implements GLEventListener, KeyListener {
		...
		public void init(GLAutoDrawable drawable) {
			if (drawable.getGL().isGL3()) {
				...
				pipeline = new PhongShaderPipeline(gl, new PMVMatrix(), material, new Light());
				pipeline.init();
				if (!pipeline.isReady()) {
	...
	public static final String TITLE = "Materials Demo, Per-Pixel-Lighting (OpenGL 3 Core)...";
