...
public class Listing12 {
	...
	static final String TITLE = "Alpha Blending (OpenGL 3, GLSL 1.30)";
	...
	static class GLEventListenerImpl implements GLEventListener {
		...
		int[] vertexCount = new int[2];
		int[] VBO = new int[2];
		int[] VAO = new int[2];
		
		float[][] colors = {
				{ 1.0F, 0.0F, 0.0F, 0.7F }, // red, 70% opacity
				{ 0.0F, 1.0F, 0.0F, 0.7F } // green, 70% opacity
		};
