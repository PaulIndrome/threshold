...
public class Punkt{
	...
	public Punkt(){ //Konstruktor mit gleichem Namen wie oben, erzeugt aber bei Weglassen von Variablen einen Punkt mit abgefragten Werten
		System.out.println("Bitte trage die x-Koordinate des neuen Punktes ein.");
		x = Keyboard.readdouble();
		System.out.println("Bitte trage die y-Koordinate des neuen Punktes ein.");
